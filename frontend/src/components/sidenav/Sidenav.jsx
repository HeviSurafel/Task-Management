    ...
    <div className="sidenav-main-container">
      ...
      <div className="sidenav-list-main-container">
        ...
        <Link to="/admin/notification">
          <div
            className={`sidenav-list ${
              location.pathname === "/admin/notification" ? "default-hover" : ""
            }`}
          >
            <span>
        ...
        <Link to="/admin/chat">
          <div
            className={`sidenav-list ${
              location.pathname === "/admin/chat" ? "default-hover" : ""
            }`}
          >
            <span>
              <MdChat className="sidenav-icon" />
            </span>
            <p className="sidenav-list-text">chat</p>
          </div>
        </Link>
